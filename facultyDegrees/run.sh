...
harvester-sparqltranslator -X facultyDegrees.config.xml
...
cp data/constructed-data ../backups/facultyDegrees-data-$DATE
cp data/constructed-data ../backups/facultyDegrees-data-last
