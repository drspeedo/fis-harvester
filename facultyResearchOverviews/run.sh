...
export HARVEST_NAME=dat-faculty-research-overviews
...
harvester-sparqltranslator -X facultyResearchOverview.config.xml
...
RESOV=`cat data/constructed-data | grep 'researchOverview' | wc -l`


echo "Imported $RESOV Research Overview"
