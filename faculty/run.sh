...
export HARVEST_NAME=dat-faculty
...
harvester-jenaconnect -X faculty.config.xml

# Backup constructed data

cp data/constructed-data ../backups/faculty-data-$DATE
cp data/constructed-data ../backups/faculty-data-last
...
#Output some counts
PEOPLE=`cat data/constructed-data | grep 'http://xmlns.com/foaf/0.1/Person' | wc -l`
